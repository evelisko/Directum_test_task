...
class PageClassification():
    ...
    def __init__(self, config_patch, logger): # Написать стоит и други процедуры после инициализации.
        ...
        try:
          ...
          # Загрузим модель.
            ...
            self.log.write(f'PageClassify_Exception: {str(ex)}')
    ...
    def get_page_type(self, image):
        ...
        try:
            ...
            self.logger.write(f'PageClassify_Exception: Ошибка интерпретации модели! Не удалось выполнить предскание. {str(e)}')
